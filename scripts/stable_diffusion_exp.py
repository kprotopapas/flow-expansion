...
@hydra.main(version_base=None, config_path="../configs", config_name="sd")
def app(cfg: DictConfig) -> None:
    ...
    trainer: MaxEntTrainer = hydra.utils.instantiate(cfg.trainer, model=fine_model, base_model=base_model)
    ...
    if os.path.exists(ckpt_path):
        ...
        print(f"Resuming from checkpoint at step {train_step}")
    else:
        # initial evaluation
